...
struct JournalDetailView: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) { // Removed NavigationView from here
            ScrollView {
        ...
        .navigationTitle("日誌詳情") // Set navigation title here
        .navigationBarTitleDisplayMode(.inline)
        .background(Color("AppBackground").ignoresSafeArea())
        // Remove .navigationBarHidden(true) as we want the navigation bar
